  ...
  return (
    <div className='w-full'>
      <div className='flex flex-col px-6 py-5 lg:h-[323px] lg:flex-row lg:justify-between lg:px-0 lg:py-10'>
        <div className='flex flex-col items-center lg:items-start'>
          <div className='space-y-1 text-balance lg:space-y-3'>
            <h1 className='font-serif text-2xl font-bold  text-violet-600 lg:text-5xl'>{data.title}</h1>
          ...
          <a
            ...
            target='_blank'
            rel='noreferrer'
            className='flex-center mt-5 min-h-5 w-full gap-1 rounded-[8px] bg-white p-[10px] text-sm capitalize text-violet-600 hover:opacity-70 lg:mt-auto lg:w-[288px]'
          >
        ...
        >
          ...
          />
          <div className='absolute inset-0 z-10 hidden items-center justify-center gap-1 rounded-[16px] bg-white bg-opacity-50 text-2xl text-violet-600 transition-all duration-200 group-hover:flex'>
      ...
      <div className='mb-5 px-3 lg:px-0'>
        <h2 className='my-5 font-serif text-2xl font-bold text-black lg:my-10'>{t('introduction')}</h2>
